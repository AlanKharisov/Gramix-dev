...
export default function CalorieOverview({ eaten, goal, base, extra, averages = [], today = true, personalAverage }) {
  ...
  return <div className={'gx-calorie-overview' + (over ? ' is-over' : '')}>
    ...
    <button className={'gx-budget-status' + (personal ? ' is-personal' : '')} onClick={() => setOpen(true)}>
