...
Average = imported basal + active energy − logged food for completed days with both energy metrics in a complete daily import and a food record. Past 7 completed days by default; switches to 30 only with all 30 recorded days. Current partial day and missing days are excluded. Until sufficient data exists the value is —, not average food consumption. Food records are not proof of a complete food diary. Import both energy metrics together to mark a day complete.
